...
int main()
{
	char *inputteclado, *path, *exit = "exit", **PATH, **pathyteclado, **inputtecladotoker;
	...
	/* Liberar espacio de otra funcion en esta?(wordtoker: Esta funcion nos dio problemas con el valgrind*/
	return(0);
}
